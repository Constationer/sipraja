                ...
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Pengajuan Proses</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Pengajuan Proses</h3>
                            </div>
                            <div class="card-body">
                                            ...
                                            @else
                                                @foreach ($data as $key)
                                                    <tr>
                                                        ...
                                                        <td>{{ $key->deskripsi }}</td>
                                                        <td>
                                                            <form id="selesai-form-{{ $key->id }}" method="POST"
                                                                action="{{ route('admin-pengajuan.sendSelesai', ['id' => $key->id]) }}">
                                                                @method('PUT')
                                                                @csrf
            ...
            document.querySelectorAll('.selesai-button').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        text: `Data akan diubah statusnya menjadi Selesai!`,
                        icon: 'warning',
                        ...
                        input: 'text',
                        inputPlaceholder: 'Masukkan keterangan disini', // Placeholder text
                    }).then((result) => {
